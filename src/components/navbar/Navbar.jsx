  ...
  return (
    <nav id="main-nav" className="all-centered">
      ...
      <NavLink to={"/"} className="nav-item all-centered">
        ...
        <NavLink to={"/skills"} className="nav-item all-centered">Skills</NavLink>
        <NavLink to={"/projects"} className="nav-item all-centered">
          Projects
        </NavLink>
        <NavLink className="nav-item all-centered">Blogs</NavLink>
        <NavLink to={"/contact"} className="nav-item all-centered">Contact</NavLink>
